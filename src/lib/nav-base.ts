...
export const rawNavMeta: NavMainItemMeta[] = [
  ...
  // 2. Laser Processing Equipment
  {
    ...
    subMetaList: [
      {
        path: 'laser-processing-equipment/sheet-cutting',
        targetId: 'sheet',
      ...
      {
        path: 'laser-processing-equipment/tube-cutting',
        targetId: 'tube',
      ...
      {
        path: 'laser-processing-equipment/sheet-tube',
        targetId: 'st',
      ...
      {
        path: 'laser-processing-equipment/welding',
        targetId: 'weld',
      ...
      {
        path: 'laser-processing-equipment/cleaning',
        targetId: 'clean',
      ...
      {
        path: 'laser-processing-equipment/marking',
        targetId: 'mark',
    ...
    productGroupMeta: {
      sheet: [
        { path: 'laser-processing-equipment/sheet-cutting/s-eco' },
        { path: 'laser-processing-equipment/sheet-cutting/s-plus' },
        { path: 'laser-processing-equipment/sheet-cutting/s-pro' },
        { path: 'laser-processing-equipment/sheet-cutting/s-promax' },
        { path: 'laser-processing-equipment/sheet-cutting/s-ultra' },
        { path: 'laser-processing-equipment/sheet-cutting/s-s' },
        { path: 'laser-processing-equipment/sheet-cutting/s-c' },
        { path: 'laser-processing-equipment/sheet-cutting/s-cpromax' },
        { path: 'laser-processing-equipment/sheet-cutting/s-g' },
        { path: 'laser-processing-equipment/sheet-cutting/s-m' },
      ],
      tube: [
        { path: 'laser-processing-equipment/tube-cutting/t2' },
        { path: 'laser-processing-equipment/tube-cutting/t2-plus' },
        { path: 'laser-processing-equipment/tube-cutting/t2-ultra' },
        { path: 'laser-processing-equipment/tube-cutting/t3-plus' },
        { path: 'laser-processing-equipment/tube-cutting/t3-ultra' },
        { path: 'laser-processing-equipment/tube-cutting/t4-ultra' },
      ],
      st: [
        { path: 'laser-processing-equipment/sheet-tube/at' },
        { path: 'laser-processing-equipment/sheet-tube/at-pro' },
        { path: 'laser-processing-equipment/sheet-tube/at-promax' },
        { path: 'laser-processing-equipment/sheet-tube/at-ultra' },
      ],
      weld: [
        { path: 'laser-processing-equipment/welding/w-eco' },
        { path: 'laser-processing-equipment/welding/w-pro' },
        { path: 'laser-processing-equipment/welding/w-ultra' },
        { path: 'laser-processing-equipment/welding/w-rw' },
        { path: 'laser-processing-equipment/welding/w-r4in1' },
        { path: 'laser-processing-equipment/welding/w-rm' },
      ],
      clean: [{ path: 'laser-processing-equipment/cleaning/c-r' }, { path: 'laser-processing-equipment/cleaning/c-c' }, { path: 'laser-processing-equipment/cleaning/c-i' }],
      mark: [
        { path: 'laser-processing-equipment/marking/m-uv' },
        { path: 'laser-processing-equipment/marking/m-mopa' },
        { path: 'laser-processing-equipment/marking/m-fiber' },
        { path: 'laser-processing-equipment/marking/m-co2' },
      ],
    },
  },
  // 3. Complete Production Line
  {
    path: 'complete-production-line/',
    ...
    subMetaList: [
      {
        path: 'complete-production-line/laser-auxiliary',
        targetId: 'aux',
      ...
      {
        path: 'complete-production-line/metal-forming',
        targetId: 'form',
      ...
      {
        path: 'complete-production-line/multi-material-cutting',
        targetId: 'multi',
    ...
    productGroupMeta: {
      aux: [
        { path: 'complete-production-line/laser-auxiliary/co2-engraver' },
        { path: 'complete-production-line/laser-auxiliary/cnc-router' },
        { path: 'complete-production-line/laser-auxiliary/mold-welder' },
        { path: 'complete-production-line/laser-auxiliary/letter-bender' },
      ],
      form: [
        { path: 'complete-production-line/metal-forming/cnc-bender' },
        { path: 'complete-production-line/metal-forming/shearing-machine' },
        { path: 'complete-production-line/metal-forming/deburrer' },
        { path: 'complete-production-line/metal-forming/slag-remover' },
        { path: 'complete-production-line/metal-forming/pipe-bender' },
      ],
      multi: [
        { path: 'complete-production-line/multi-material-cutting/plasma-cutter' },
        { path: 'complete-production-line/multi-material-cutting/glass-cutter' },
        { path: 'complete-production-line/multi-material-cutting/vibrating-cutter' },
      ],
    },
  },
